    ...
    <div className="min-h-screen bg-[#eaf8f1] flex items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-[28px] overflow-hidden shadow-2xl shadow-emerald-200/60 bg-white border border-emerald-100">
        <div className="relative h-[340px] bg-gradient-to-br from-emerald-400 via-emerald-500 to-teal-500">
          ...
          <div
            className="absolute right-4 top-[108px] w-44 h-44 opacity-[0.2] pointer-events-none"
            style={{
          ...
          <div className="relative z-10 p-6 pt-8 text-white">
            ...
            <div className="mt-3 grid grid-cols-2 gap-2 max-w-[300px]">
              <div className="rounded-xl border border-emerald-200/45 bg-white/10 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-emerald-100/80">Status</p>
                <p className="text-xs font-semibold text-white mt-0.5">Sistem Internal Aktif</p>
              </div>
              <div className="rounded-xl border border-emerald-200/45 bg-white/10 px-3 py-2">
                <p className="text-[10px] uppercase tracking-wide text-emerald-100/80">Sesi</p>
                <p className="text-xs font-semibold text-white mt-0.5">Auto-timeout 4 jam</p>
              </div>
            </div>
          </div>
        </div>
