  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">Integrasi awal active ke endpoint variant live dengan klasifikasi stok aman/menipis/habis.</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Threshold low stock default: ≤ {LOW_STOCK_THRESHOLD}</CardDescription>
        </CardHeader>
