    ...
    <div className="space-y-8 pb-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Monitor payment transactions from the live backend.</p>
        </div>
      ...
      <Card className="border-none shadow-sm rounded-3xl bg-orange-50 border-orange-100 overflow-hidden p-8">
        ...
        <p className="text-orange-700 text-sm mt-2 leading-relaxed">
          Payments page is connected to the live backend endpoint with basic transaction status filtering and frontend search. Payment detail drill-down can be added in the next batch if needed.
        </p>
        <p className="mt-2 text-[10px] font-bold text-orange-800 uppercase tracking-wider">
          Source: GET /admin/payments
        </p>
      </Card>
    </div>
  );
