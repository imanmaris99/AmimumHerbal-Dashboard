...
export default function CashierPage() {
  ...
  const buildInvoiceHtml = (receipt: ReceiptData) => {
    ...
    return `<!doctype html><html><head><meta charset="utf-8"><title>Invoice ${receipt.transactionId}</title>
      ...
      <div class="footer">TERIMAKASIH ATAS PEMBELIAN ANDA<br/>Shopee: shopee.co.id/tokoherbalamimum<br/>Tokopedia: tokopedia.com/herbalamimum</div>
  ...
  const buildReceiptPlainText = (receipt: ReceiptData) => {
    ...
    return [
      ...
      center('tokopedia.com/herbalamimum'),
      center('Terima kasih'),
      '\n',
    ].join('\n');
  };
